package com.italomaciel.cursomc.domain;
...
//Tem duas estratégias, quando tem muitos atributos em sub-classes usa-se a estratégia de tabelas distintas, para poucos atributos usa a estratégia de uma tabela única em que o id será nulo.
@Entity
